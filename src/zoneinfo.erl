...
parse_header_v0(<<"TZif", Version:8, _:15/bytes,
    ...
    TTbinSize = TimeCnt * 4,
    TTinfoBinSize = TypeCnt * 6,
    LeapSecBinSize = LeapCnt * 8,
    <<TTbin:TTbinSize/bytes,
      NextTTIdxBin:TimeCnt/bytes,
      TTinfoBin:TTinfoBinSize/bytes,
      ZoneAbrevBin:CharCnt/bytes,
      LeapSecBin:LeapSecBinSize/bytes,
